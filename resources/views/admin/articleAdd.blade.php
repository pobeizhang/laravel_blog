...
@section('title','添加文章页面')
@section('content')
    <!--面包屑导航 开始-->
    <div class="crumb_warp">
        <!--<i class="fa fa-bell"></i> 欢迎使用登陆网站后台，建站的首选工具。-->
        <i class="fa fa-home"></i>
        <a href="/admin/info">首页</a> &raquo;添加文章
    </div>
    <!--面包屑导航 结束-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="/admin/toArticleList"><i class="fa fa-recycle"></i>文章列表</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
        ...
        <table class="add_tab">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" disabled name="thumb">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="" id="thumb_preview" style="max-width: 350px;max-height: 100px;">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th></th>
                    <td>
                        <input type="submit" onclick="articleAdd();" value="提交">
...
@section('my-js')
    ...
    <script>
        function articleAdd(){
            ...
            $.ajax({
               url:'/admin/service/articleAdd',
                type:'post',
                dataType:'json',
                cache:false,
                data:{id:id,title:title,editor:editor,thumb:thumb,key:key,description:description,content:content,_token:"{{csrf_token()}}"},
