...
class Data {
   ...
   * @return array
   */
  public function channelList($data, $pid = 0, $html = "&nbsp;", $fieldPri = 'id', $fieldPid = 'pid', $level = 1)
  {
  ...
  //只供channelList方法使用
  private function _channelList($data, $pid = 0, $html = "&nbsp;", $fieldPri = 'id', $fieldPid = 'pid', $level = 1)
  {
    /*if (empty($data))
      return array();*/
    $arr = array();
   ...
   * @return array
   */
  public function tree($data, $title, $fieldPri = 'id', $fieldPid = 'pid')
  {
   ...
   * @return array
   */
  public function parentChannel($data, $sid, $fieldPri = 'id', $fieldPid = 'pid')
  {
    /*if (empty($data)) {
      return $data;*/
//    } else {
...
//    }
   ...
   * @return bool
   */
  function isChild($data, $sid, $pid, $fieldPri = 'id', $fieldPid = 'pid')
  {
